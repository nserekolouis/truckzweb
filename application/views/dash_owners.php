...
<div id="main">
  ...
  <h3><?php echo anchor('main/view_truck_owners', lang('towner_all'))?> | <?php echo anchor('main/view_individual_truck_owners', lang('towner_individuals'))?> | 
          <?php echo anchor('main/view_company_truck_owners', lang('towner_company'))?></h3>

  <div class="grid-container">
     <?php foreach ($owners as $owner):?>
      <?php include('includes/layout_owner.php')?>
      <?php endforeach;?>
  </div>
  <?php if(!empty($links)){;?>
